...
<main class="page px-5 pt-9 pb-24">
    ...
    <p class="text-sm text-gray-500 mb-6 max-w-sm">Enter your email and we'll send you a link to reset your password.</p>
    ...
    {#if form?.sent}
        <div class="max-w-sm">
            ...
            <p class="text-xs text-gray-500">
                ...
                {#if form.resetLink}
                    <br />Debug: <a href="/change-password?token={form.resetLink.split('token=')[1]}" class="text-blue-600 hover:underline">reset link</a>
                {/if}
            </p>
        </div>
    {:else}
